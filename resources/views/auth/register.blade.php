                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="index.html" class="brand-logo">
                                ...
                                <h2 class="brand-text text-primary ms-1">LikeLy</h2>
                            </a>

                            <h4 class="card-title mb-1">Приключение начинается здесь 🚀</h4>
                            <p class="card-text mb-2">Сделайте развитие вашего аккаунта простым и увлекательным!</p>
                            ...
                            <form class="auth-register-form mt-2" action="{{route('registration')}}" method="POST">
                                @csrf
                                <div class="mb-1">
...
{{--                                    </div>--}}
{{--                                </div>--}}
                                <button class="btn btn-primary w-100" tabindex="5">Зарегистрироваться</button>
                            </form>

                            <p class="text-center mt-2">
                                <span>Уже есть аккаунт?</span>
                                <a href="{{route('login')}}">
                                    <span>Войдите в него</span>
                                </a>
                            </p>

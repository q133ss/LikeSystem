                ...
                <div class="auth-inner my-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <p class="card-text mb-2">Пожалуйста, войдите в свой аккаунт, что бы получить доступ к сервису</p>
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form class="auth-login-form mt-2" action="{{route('auth')}}" method="POST">
                                @csrf
                                <div class="mb-1">
